				...
				<nav id="header" class="navbar navbar-fixed-top">
					<div id="header-container" class="container navbar-container">
						<div class="navbar-header">
							...
							<a id="brand" class="navbar-brand" href="#slider"><img src="images/logo-011.png" alt="logo" class="img-responsive"></a>
						</div>
	...
	<!-- banner part start -->	
		<section id="slider">
			...
			<div class="slider-img">
				<div class="slide-banner" style="background: url(images/UIU-Campus0-1024x767.jpg)">
					<div class="overly">
						<div class="banner-content">
							<div class="container text-center">
								<div class="banner-text">
									...
									<h3>UIU CLUBHUB</h3>
									<p>A students community made by students made for the students</p>
									<a class="vm" href="#portfolio">view more</a>
									<!-- <a href="#">Hire us</a> -->
								</div>
							</div>
						</div>
				...
				<div class="slide-banner" style="background: url(images/UIU-Campus-5.jpg)">
					<div class="overly">
						<div class="banner-content">
							<div class="container text-center">
								<div class="banner-text">
				...
				<div class="slide-banner" style="background: url(images/UIU-Campus-1-1024x768.jpg)">
					<div class="overly">
						<div class="banner-content">
							<div class="container text-center">
								<div class="banner-text">
									...
									<div class="portfolio-inner">
										<div class="port-img">
											<div class="port-overlay">
													<a class="venobox" data-gall="gallery01" href="images/img-1.jpg"><i class="fa fa-search-plus"></i></a>
													</div>
												<img src="images/img-1.jpg" alt="port1" class="img-responsive">
											</div>
										<div class="port-img">
											<div class="port-overlay">
												<a class="venobox" data-gall="gallery01" href="images/img-2.jpg"><i class="fa fa-search-plus"></i></a></div>
											<img src="images/img-2.jpg" alt="port2" class="img-responsive">
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="portfolio-inner">
										<div class="port-img">
											<div class="port-overlay">
												<a class="venobox" data-gall="gallery01" href="images/img-3.jpg"><i class="fa fa-search-plus"></i></a>
											</div>
											<img src="images/img-3.jpg" alt="port1" class="img-responsive">
										</div>
										<div class="port-img">
											<div class="port-overlay">
												<a class="venobox" data-gall="gallery01" href="images/img-4.jpg"><i class="fa fa-search-plus"></i></a>
											</div>
											<img src="images/img-4.jpg" alt="port2" class="img-responsive">
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="portfolio-inner">
										<div class="port-img">
											<div class="port-overlay">
												<a class="venobox" data-gall="gallery01" href="images/img-5.jpg"><i class="fa fa-search-plus"></i></a>
											</div>
											<img src="images/img-5.jpg" alt="port1" class="img-responsive">
										</div>
										<div class="port-img">
											<div class="port-overlay">
												<a class="venobox" data-gall="gallery01" href="images/img-6.jpg"><i class="fa fa-search-plus"></i></a>
											</div>
											<img src="images/img-6.jpg" alt="port2" class="img-responsive">
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="portfolio-inner">
										<div class="port-img">
											<div class="port-overlay">
												<a class="venobox" data-gall="gallery01" href="images/img-7.jpg"><i class="fa fa-search-plus"></i></a>
											</div>
											<img src="images/img-7.jpg" alt="port1" class="img-responsive">
										</div>
										<div class="port-img">
											<div class="port-overlay">
												<a class="venobox" data-gall="gallery01" href="images/img-8.jpg"><i class="fa fa-search-plus"></i></a>
											</div>
											<img src="images/img-8.jpg" alt="port2" class="img-responsive">
										</div>
									</div>
								</div>
								<div class="col-md-3">
			...
			<div class="container">
				<div class="row">
					<div class="price-heading text-center">
							<h2>Wall of fame</h2>
							<p>Top performer of the trimester for Fall - 2022</p>
						</div>
					<div class="price">
...
<!-- Mirrored from themesitem.com/demos/html/Hunt/demo/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Apr 2019 18:31:41 GMT -->
</html>